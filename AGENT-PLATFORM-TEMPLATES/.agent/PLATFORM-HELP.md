...
Available: languages — `language-typescript`, `language-java`, `language-cpp`; stacks — `stack-react`, `stack-django`; domains — `domain-fintech` (example). Build your own in a private fork (company IP → packs). Full spec: `.agent/packs/README.md`.
